...
export function getProvider(provider, model) {
    ...
    switch (normalizedProvider) {
        ...
        default:
            throw new Error(`Unsupported provider: ${provider}. Supported: ${Object.keys(SUPPORTED_PROVIDERS).join(', ')}`);
    }
}
/**
 ...
 */
export async function* streamTextWithProvider(provider, model, prompt, systemPrompt) {
